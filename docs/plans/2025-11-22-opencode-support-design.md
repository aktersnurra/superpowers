...
1. **Create isolated workspace** (current workflow: use `using-jj-workspaces` / `jj workspace add`; this historical plan originally used the previous Git isolation workflow)
   - Bookmark: `feature/opencode-support`
